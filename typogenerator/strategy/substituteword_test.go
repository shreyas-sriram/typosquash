...
func TestSubstituteWordNone(t *testing.T) {
	out, err := strategy.SubstituteWord.Generate("zenithar", "")
	if err != nil {
		t.Fail()
...
func TestSubstituteWordOne(t *testing.T) {
	out, err := strategy.SubstituteWord.Generate("python-dateutil", "")
	if err != nil {
		t.Fail()
		t.Fatal("Error should not occurs !", err)
	}
